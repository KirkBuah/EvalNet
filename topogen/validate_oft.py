...
# validate a created Two-Level Orthogonal Fat-Tree topology
...
def validate(graph : [[int]], k : int) -> int:
    ...
    # check that two distinct nodes in Layer 02 connect to exactly one or exactly k in common nodes of Layer 1
